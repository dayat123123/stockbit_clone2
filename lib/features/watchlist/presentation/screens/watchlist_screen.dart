        ...
        return BlocBuilder<WatchlistBloc, WatchlistState>(
          builder: (context, state) {
              ...
              return Center(
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      const Icon(Icons.error_outline, size: 20, color: AppColors.offerRed),
                      ...
                      InkWell(
                        onTap: () => context.read<WatchlistBloc>().add(const LoadWatchlistEvent()),
                        child: Container(
                          ...
                          child: const Text('Retry', style: TextStyle(fontSize: 10, color: Colors.white)),
                        ),
                      ),
                    ],
                  ),
            ...
            if (state is WatchlistLoadedState) {
              ...
              final rawItems = state.filteredItems;
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      child: _isSearching
                          ? Row(
                              children: [
                                const Icon(Icons.search, size: 13, color: AppColors.primaryGreen),
                              ...
                              itemBuilder: (context, index) {
                                ...
                                return InkWell(
                                  onTap: () {
                                    context
                                        .read<WatchlistBloc>()
                                        .add(SelectActiveStockEvent(stock.symbol));
                                    try {
