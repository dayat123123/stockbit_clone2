      ...
      child: ConstrainedBox(
        ...
        child: BlocBuilder<AuthBloc, AuthState>(
          builder: (context, state) {
            ...
            final errorMsg =
                state is AuthUnauthenticatedState ? state.errorMessage : null;
            ...
            return Column(
              ...
              children: [
                ...
                InkWell(
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      borderRadius: BorderRadius.circular(6),
                      border: Border.all(color: const Color(0xFF323842), width: 1),
                    ),
                    child: Row(
                ...
                Row(
                  children: const [
                    Expanded(child: Divider(color: Color(0xFF2E343E), thickness: 1)),
                    Padding(
                ...
                if (errorMsg != null) ...[
                  Container(
                    ...
                    child: Text(
                      errorMsg,
                      style: const TextStyle(fontSize: 11, color: AppColors.offerRed),
                    ),
                  ),
                ...
                Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    borderRadius: BorderRadius.circular(6),
                    border: Border.all(color: const Color(0xFF2E343E), width: 1),
                  ),
                  child: TextField(
                    ...
                    decoration: const InputDecoration(
                      ...
                      hintStyle: TextStyle(fontSize: 12.5, color: Color(0xFF6B7280)),
          ...
          Expanded(
            child: Center(
              child: AspectRatio(
                aspectRatio: 1.0,
                child: CustomPaint(
                  painter: _StockbitIsometricDeskPainter(),
                ),
              ),
            ),
          ),
...
class _StockbitIsometricDeskPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    canvas.drawLine(Offset(w * 0.15, h * 0.2), Offset(w * 0.35, h * 0.28), mintGreen);
    canvas.drawLine(Offset(w * 0.2, h * 0.26), Offset(w * 0.42, h * 0.35), mintGreen);
    canvas.drawLine(Offset(w * 0.35, h * 0.16), Offset(w * 0.55, h * 0.24), purple);
    canvas.drawLine(Offset(w * 0.8, h * 0.35), Offset(w * 0.95, h * 0.42), mintGreen);
    canvas.drawLine(Offset(w * 0.82, h * 0.48), Offset(w * 0.98, h * 0.54), purple);
    canvas.drawLine(Offset(w * 0.45, h * 0.82), Offset(w * 0.55, h * 0.86), purple);
    ...
    canvas.drawLine(pieCenter, Offset(pieCenter.dx, pieCenter.dy - h * 0.04), mintGreen);
    canvas.drawLine(pieCenter, Offset(pieCenter.dx + w * 0.06, pieCenter.dy + h * 0.02), mintGreen);

    // ── 3. Top-Right Modular Blocks / Windows ────────────────────────────────
    _drawIsoBlock(canvas, Offset(w * 0.8, h * 0.26), w * 0.08, h * 0.05, mintGreen);
    _drawIsoBlock(canvas, Offset(w * 0.86, h * 0.29), w * 0.07, h * 0.04, mintGreen);
    ...
    canvas.drawLine(Offset(w * 0.20, h * 0.49), Offset(w * 0.20, h * 0.44), mintGreen);
    canvas.drawLine(Offset(w * 0.24, h * 0.47), Offset(w * 0.24, h * 0.39), mintGreen);
    canvas.drawLine(Offset(w * 0.28, h * 0.45), Offset(w * 0.28, h * 0.41), mintGreen);
    ...
    for (int i = 1; i <= 4; i++) {
      final t = i / 5.0;
      final start = Offset.lerp(Offset(w * 0.41, h * 0.74), Offset(w * 0.53, h * 0.81), t)!;
      final end = Offset.lerp(Offset(w * 0.72, h * 0.63), Offset(w * 0.84, h * 0.70), t)!;
    ...
    _drawLeaf(canvas, Offset(w * 0.28, h * 0.74), Offset(w * 0.26, h * 0.67), purple);
    _drawLeaf(canvas, Offset(w * 0.32, h * 0.74), Offset(w * 0.31, h * 0.64), purple);
    _drawLeaf(canvas, Offset(w * 0.36, h * 0.74), Offset(w * 0.38, h * 0.68), purple);
  }

  void _drawIsoBlock(Canvas canvas, Offset pos, double w, double h, Paint paint) {
    final path = Path()
  ...
  void _drawLeaf(Canvas canvas, Offset base, Offset tip, Paint paint) {
    final path = Path()
      ...
      ..quadraticBezierTo(base.dx + 8, (base.dy + tip.dy) / 2, base.dx, base.dy);
    canvas.drawPath(path, paint);
