...
class OrdersScreen extends StatefulWidget {
  ...
  const OrdersScreen({super.key, this.initialSymbol, this.initialIsBuy = true});
...
class _OrdersScreenState extends State<OrdersScreen> {
  ...
  void initState() {
    ...
    _symbolController = TextEditingController(
      text: widget.initialSymbol ?? 'PACK',
    );
    _priceController = TextEditingController(text: '510');
                        ...
                        Row(
                          children: [
                            IconButton(
                              onPressed: () {
                                final cur =
                                    int.tryParse(_priceController.text) ?? 500;
                                if (cur > 1) {
                                  setState(
