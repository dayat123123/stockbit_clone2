...
/// Optimized with [RepaintBoundary] and isolated sub-tree updates for zero performance overhead.
class DesktopBottomTicker extends StatelessWidget {
              ...
              child: ConstrainedBox(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    // ── Right: Latency & Isolated Clock ──────────────────────
                    Row(
                      mainAxisSize: MainAxisSize.min,
                      children: const [
                        Icon(Icons.signal_cellular_alt, size: 11, color: AppColors.primaryDark),
                        SizedBox(width: 8),
  ...
  static Widget _buildTickerItem(
    String symbol,
    String price,
    String change,
    Color color,
...
/// Isolated widget for real-time clock to prevent cascading parent rebuilds.
