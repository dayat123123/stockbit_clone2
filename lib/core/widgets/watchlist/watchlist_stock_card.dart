...
import 'package:stockbit_clone2/core/widgets/watchlist/mini_sparkline_painter.dart';
        ...
        return InkWell(
          onTap: () {
            ...
            context.read<WatchlistBloc>().add(
              SelectActiveStockEvent(item.symbol),
            );
            try {
              context.read<WorkspaceBloc>().add(
                GlobalSearchSymbolEvent(item.symbol),
              );
            } catch (_) {}
          },
          onDoubleTap: () {
            // Double tap: navigate directly to full Watchlist Stock Detail page with argument
            context.read<WatchlistBloc>().add(
              SelectActiveStockEvent(item.symbol),
            );
            try {
            ...
            context.read<NavigationCubit>().navigateToWatchlist(
              symbol: item.symbol,
            );
          },
          child: AnimatedContainer(
            ...
            decoration: BoxDecoration(
              color: isSelected ? const Color(0xFF19232B) : Colors.transparent,
              border: Border(
                left: BorderSide(
                  color: isSelected
