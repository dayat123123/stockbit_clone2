                        ...
                        child: Stack(
                          ...
                          children: [
                            ...
                            FractionallySizedBox(
                              ...
                              child: Container(color: AppColors.bidGreenSubtle),
                            ),
                            Padding(
                                ...
                                children: [
                                  ...
                                  Expanded(
                                    ...
                                    child: FittedBox(
                                      ...
                                      child: Text(
                                        row.bidLot > 0
                                            ? numberFormat.format(row.bidLot)
                                            : '-',
                                        style: const TextStyle(
                                          fontSize: 8.5,
                        ...
                        child: Stack(
                          ...
                          children: [
                            ...
                            FractionallySizedBox(
                              ...
                              child: Container(color: AppColors.offerRedSubtle),
                            ),
                            Padding(
                              padding: const EdgeInsets.symmetric(
                                horizontal: 4,
                                ...
                                children: [
                                  ...
                                  Expanded(
                                    ...
                                    child: FittedBox(
                                      ...
                                      child: Text(
                                        row.offerLot > 0
                                            ? numberFormat.format(row.offerLot)
                                            : '-',
                                        style: const TextStyle(
                                          fontSize: 8.5,
                                          color: AppColors.textPrimary,
